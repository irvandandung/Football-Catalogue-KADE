...
import com.example.myfootballmatchschedule.BuildConfig
...
object ApiUrl {
    ...
    fun getNextMatch(idnext: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .appendQueryParameter("id", idnext)
            .build()
            .toString()
    }

    fun getLastMatch(idpast: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
            .appendPath("api")
            .appendPath("v1")
            .appendPath("json")
            ...
            .appendQueryParameter("id", idpast)
            .build()
            .toString()
    }
