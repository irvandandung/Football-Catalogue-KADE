...
class LastMatchFragment : Fragment(), AnkoComponent<Context>, MatchView {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        presenter = LastMatchPresenter(this, request, gson, fixture)
        presenter.getLastMatchpresenter(leagueId)
